...
def get_next_step():
    global screenshot_requested
    url = os.getenv('01AGENT_API_URL') + '/aiagent/background/' + os.getenv('01AGENT_THREAD_ID') + '/next_step'
    headers = {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer ' + os.getenv('01AGENT_USER_ACCESS_TOKEN'),
    }
...
async def main_loop():
    while True:
        ...
        print("01Agent Next Step Response:", action_response)

...
import _01agent_logo_white from '../assets/01agent_logo_white.png';
  ...
  return (
    <>
      <MainContainer>
        <AccountContainer>
          <AccountHeader>
            <a href={constants.AGENT_LINK} target="_blank" rel="noreferrer" style={{textDecoration: 'none'}}>
              <img
                src={_01agent_logo_white}
                height={65}
                alt="01Agent"
            ...
            <Button color={'var(--sci-fi-green)'}
              padding="14px 20px"
              onClick={() => navigate('/login')}
              borderRadius={4} /* Sharper corners */
              outlined /* Use outlined style */
              style={{border: '1px solid var(--sci-fi-green)'}} /* Sci-fi green border */
              >
              Login
            </Button>
          </AccountHeader>
          <AccountDiv>
            <InfoContainer>
              ...
              <AccountTextField placeholder={'Confirm Password'} style={{marginTop: '5px'}} type="password"
                ...
                onKeyDown={(e) => handleKeyDown(e)} />
              <Button color={'var(--sci-fi-green)'} padding="14px" fontSize="18px" borderRadius={4} /* Sharper corners */
                block
                elevated /* Add elevated style for glow */
              ...
              <div style={{marginTop: '10px', textAlign: 'center'}}>
                <OrDiv>
                  <Text fontSize="18px" color="var(--text-light)"> /* Sci-fi text color */
                    OR
                  </Text>
                </OrDiv>
                <Button color={'var(--text-light)'} padding="10px 14px" fontSize="16px" borderRadius={4} /* Sharper corners */
                  block
                  outlined /* Use outlined style */
                  style={{marginTop: '10px', border: '1px solid var(--border-dark)'}} /* Sci-fi border */
                  onClick={() => loginWithGoogle()}>
                  <BtnIcon iconSize='22px' left color={'var(--sci-fi-green)'}> /* Sci-fi green icon */
                    <FcGoogle />
                  </BtnIcon>

...
export const Chip = styled.div`
  ...
  color: ${props => (props.outlined && props.color) ? props.color : (props.dark) ? 'var(--light-background)' : 'var(--third-color)'};
  text-decoration: none;
  border: none;
  width: ${props => props.block ? '100%' : 'auto'};
  outline: ${props => (props.outlined) ? (props.color ? (props.color + ' 2px solid') : ('var(--third-color) 2px solid')) : 'none'};

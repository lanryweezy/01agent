...
async def create_login_session(user: User, db_session: AsyncSession, expires_at: datetime.datetime, session_type: LoginSessionTypes = LoginSessionTypes.WINDOWS, notification_token: Optional[str] = None):
    """
